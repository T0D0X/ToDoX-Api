FROM eclipse-temurin:21-jdk as stage0
LABEL snp-multi-stage="intermediate"
LABEL snp-multi-stage-id="0c3612c0-359f-48cb-8a2c-09f5b2cf998e"
WORKDIR /opt/docker
COPY 2/opt /2/opt
COPY 4/opt /4/opt
USER root
...
RUN ["chmod", "u+x,g+x", "/4/opt/docker/bin/todox-api"]
...
EXPOSE 8080
USER 1001:0
ENTRYPOINT ["/opt/docker/bin/todox-api"]
CMD []
